...
class MyAxios {
    ...
    private request(method: string, url: string, config?: {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            Object.entries(headersDemo).forEach(([key, value]) => {
                headers[key] = value
            })
            ...
            await fetch(requestURL, {
                ...
                const response: AxiosResponse = {
                    ...
                    headers: this.parseHeaders(res.headers),
                    config: {
    ...
    private parseHeaders(headers: string | Headers): Record<string, string> {
