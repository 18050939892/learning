...
function setscreen(){
    const {setscrstyle,setSetscrstyle,style,setStyle}=useContext(StyleContext)
            ...
            switch(theme) {
                case '暗夜':
                    ...
                    setStyle({
                        ...
                        svg: <svg t="1741273897782" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4249" width="200" height="200"  onClick={handleOnclick}><path d="M550.848 502.496l308.64-308.896a31.968 31.968 0 1 0-45.248-45.248l-308.608 308.896-308.64-308.928a31.968 31.968 0 1 0-45.248 45.248l308.64 308.896-308.64 308.896a31.968 31.968 0 1 0 45.248 45.248l308.64-308.896 308.608 308.896a31.968 31.968 0 1 0 45.248-45.248l-308.64-308.864z" p-id="4250" fill="#ffffff"></path></svg>
                    });
                    break;
                case '护眼':
                    newTheme = '极客';
    ...
    return (
        <div className="setscreen " id="set" style={{display:setscrstyle.display,backgroundColor:style.backgroundColor,color:style.color}}>
                ...
                <ul>
                    <li>
                        ...
                        <div className="number-box">
                            <input type="button" className="on-number" value="<" data-v="<" onMouseDown={zjOnmouseDown}/>
                    ...
                    <li>
                        ...
                        <div className="number-box">
                            <input type="button" className="on-number" value="-" data-v="-1"/>
                    ...
                    <li>
                        ...
                        <div className="check" name="toumo">
                            <a href="#" className="true">开启</a>
                    ...
                    <li>
                        ...
                        <div className="check" name="yincang">
                            <a href="#" className="true">开启</a>
                            <a href="#" className="empty"></a>
                            <a href="#" className="close">关闭</a>
                        </div>
                    ...
                    <li>
                        ...
                        <div className="check" name="logo" id="logo">
                            <a href="#" className="true">开启</a>
                            <a href="#" className="empty"></a>
                            <a href="#" className="close">关闭</a>
                        </div>
                    ...
                    <li>
                        ...
                        <div className="check" name="first">
                            <a href="#" className="true">开启</a>
                            <a href="#" className="empty"></a>
                            <a href="#" className="close">关闭</a>
                        </div>
