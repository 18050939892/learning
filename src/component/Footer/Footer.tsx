    ...
    return (
        <footer style={{backgroundColor: style.backgroundColor}}>
            ...
            >
                ...
                <svg
                    t="1741099043772" className="icon" viewBox="0 0 1024 1024" version="1.1"
